...
pu_pipe.append(pipa.system.find_in_path)
pu_pipe.append(pipa.system.open_files)
pu_pipe.append(pipa.util.item.MakeItem, func=make_items_from_file)
pu_pipe.append(pipa.util.item.Memory, fields_names=['path'])
pu_pipe.append(pipa.system.item.ReadFromFile)
pu_pipe.append(grep_in_line, grep='addNote,checkCap,deleteUserProfile,deleteSubscriptionById,getCatalog,getInterestList,getProfessionList,getQualificationList,getUserInfo,getUserInfoEx,subscribe,update,updateSubscriptionById,updateSubscriptions,updateUserProfile,pullOutMsisdn,updateUserProfileNVL,setAssentList,getAssentList')
pu_pipe.append(grep_in_line, grep='FreetimeWs')
pu_pipe.append(group_by_method_pu)
...
ft_pipe.append(pipa.system.find_in_path)
ft_pipe.append(pipa.system.open_files)
ft_pipe.append(pipa.util.item.MakeItem, func=make_items_from_file)
ft_pipe.append(pipa.util.item.Memory, fields_names=['path'])
ft_pipe.append(pipa.system.item.ReadFromFile)
ft_pipe.append(grep_in_line, grep='FreetimeExSkeleton')
ft_pipe.append(grep_in_line, grep='INFO')
ft_pipe.append(group_by_method_fex)
